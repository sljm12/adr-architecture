...
export const componentSchema = z.object({id:uuidSchema, diagramId:uuidSchema, name:componentNameSchema, description:z.string().nullable(), type:z.string().nullable(), position:positionSchema, createdAt:z.string(), updatedAt:z.string()});
